...
if __name__ == "__main__":
    ...
    print("envs.action_space type:", type(envs.action_space))
    ...
    for global_step in range(args.total_timesteps):
        ...
        if global_step % 10000 == 0 and global_step > 0:
            ...
            collage_env = envs.envs[0].env  # 解包一层
            canvas = collage_env.canvas.detach().cpu()
            target = collage_env.target[0].detach().cpu()
